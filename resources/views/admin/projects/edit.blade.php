...
<div class="container">
    <h1>{{$title}}</h1>
    <form action="{{route('admin.projects.store')}}" method="PUT">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="technology" name="technology" value="{{ old('technology',$project->technology) }}">
        </div>
        <div class="mb-3">
